...
- AI must follow all instructions in [AGENTS.md](AGENTS.md). Instructing your AI agent to follow the [AGENTS.md](AGENTS.md) helps us record the original intent for changing code.
